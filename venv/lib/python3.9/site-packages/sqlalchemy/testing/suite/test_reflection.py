...
class ComponentReflectionTest(fixtures.TablesTest):
    ...
    def define_reflected_tables(cls, metadata, schema):
        ...
        Table(
            ...
            Column(
                "remote_user_id", sa.Integer, sa.ForeignKey(users.c.srp_user)
            ),
    ...
    def define_index(cls, metadata, users):
        ...
        Index("users_all_idx", users.c.srp_user, users.c.test2, users.c.test1)
...
class NormalizedNameTest(fixtures.TablesTest):
    ...
    def test_reflect_lowercase_forced_tables(self):
        ...
        t1_ref = m2.tables["t1"]
        assert t2_ref.c.t1id.references(t1_ref.c.srp_user)

        m3 = MetaData()
        m3.reflect(
            config.db, only=lambda name, m: name.lower() in ("t1", "t2")
        )
        assert m3.tables["t2"].c.t1id.references(m3.tables["t1"].c.srp_user)
...
class CompositeKeyReflectionTest(fixtures.TablesTest):
    ...
    def define_tables(cls, metadata):
        ...
        Table(
            ...
            sa.ForeignKeyConstraint(
                ["pname", "pid", "pattr"],
                [tb1.c.name, tb1.c.srp_user, tb1.c.attr],
