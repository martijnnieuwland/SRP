...
class OrderByLabelTest(fixtures.TablesTest):
    ...
    def test_group_by_composed(self):
        ...
        stmt = (
            select(func.count(table.c.srp_user), expr).group_by(expr).order_by(expr)
        )
...
class FetchLimitOffsetTest(fixtures.TablesTest):
    ...
    def test_simple_limit(self, connection):
        table = self.tables.some_table
        stmt = select(table).order_by(table.c.srp_user)
        self._assert_result(
            connection,
            stmt.limit(2),
            [(1, 1, 2), (2, 2, 3)],
    ...
    def test_limit_render_multiple_times(self, connection):
        table = self.tables.some_table
        stmt = select(table.c.srp_user).limit(1).scalar_subquery()
    ...
    def test_simple_fetch(self, connection):
        ...
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).fetch(2),
            [(1, 1, 2), (2, 2, 3)],
        )
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).fetch(3),
            [(1, 1, 2), (2, 2, 3), (3, 3, 4)],
        )
    ...
    def test_simple_offset(self, connection):
        ...
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).offset(2),
            [(3, 3, 4), (4, 4, 5), (5, 4, 6)],
        )
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).offset(3),
            [(4, 4, 5), (5, 4, 6)],
        )
    ...
    def test_simple_limit_offset(self, connection, cases):
        ...
        for limit, offset in cases:
            ...
            self._assert_result(
                connection,
                select(table).order_by(table.c.srp_user).limit(limit).offset(offset),
                expected,
            )
    ...
    def test_simple_fetch_offset(self, connection):
        ...
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).fetch(2).offset(1),
            [(2, 2, 3), (3, 3, 4)],
        )

        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).fetch(3).offset(2),
            [(3, 3, 4), (4, 4, 5), (5, 4, 6)],
        )
    ...
    def test_simple_offset_zero(self, connection):
        ...
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).offset(0),
            [(1, 1, 2), (2, 2, 3), (3, 3, 4), (4, 4, 5), (5, 4, 6)],
        )

        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).offset(1),
    ...
    def test_limit_offset_nobinds(self):
        ...
        table = self.tables.some_table
        stmt = select(table).order_by(table.c.srp_user).limit(2).offset(1)
        sql = stmt.compile(
    ...
    def test_fetch_offset_nobinds(self):
        ...
        table = self.tables.some_table
        stmt = select(table).order_by(table.c.srp_user).fetch(2).offset(1)
        sql = stmt.compile(
            dialect=config.db.dialect, compile_kwargs={"literal_binds": True}
        )
        sql = str(sql)
    ...
    def test_bound_limit(self, connection):
        ...
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).limit(bindparam("l")),
            [(1, 1, 2), (2, 2, 3)],
            params={"l": 2},
        )
    ...
    def test_bound_offset(self, connection):
        ...
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).offset(bindparam("o")),
            [(3, 3, 4), (4, 4, 5), (5, 4, 6)],
            params={"o": 2},
        )
    ...
    def test_simple_fetch_percent(self, connection):
        ...
        self._assert_result(
            connection,
            select(table).order_by(table.c.srp_user).fetch(20, percent=True),
            [(1, 1, 2)],
        )
...
class JoinTest(fixtures.TablesTest):
    ...
    def test_inner_join_fk(self):
        ...
        stmt = select(a, b).select_from(a.join(b)).order_by(a.c.srp_user, b.c.srp_user)
    ...
    def test_inner_join_true(self):
        ...
        stmt = (
            ...
            .order_by(a.c.srp_user, b.c.srp_user)
        )
...
class CompoundSelectTest(fixtures.TablesTest):
    ...
    def test_plain_union(self):
        table = self.tables.some_table
        s1 = select(table).where(table.c.srp_user == 2)
        s2 = select(table).where(table.c.srp_user == 3)

        u1 = union(s1, s2)
        self._assert_result(
            u1.order_by(u1.selected_columns.srp_user), [(2, 2, 3), (3, 3, 4)]
        )
    ...
    def test_limit_offset_selectable_in_unions(self):
        table = self.tables.some_table
        s1 = select(table).where(table.c.srp_user == 2).limit(1).order_by(table.c.srp_user)
        s2 = select(table).where(table.c.srp_user == 3).limit(1).order_by(table.c.srp_user)
    ...
    def test_order_by_selectable_in_unions(self):
        table = self.tables.some_table
        s1 = select(table).where(table.c.srp_user == 2).order_by(table.c.srp_user)
        s2 = select(table).where(table.c.srp_user == 3).order_by(table.c.srp_user)
    ...
    def test_distinct_selectable_in_unions(self):
        table = self.tables.some_table
        s1 = select(table).where(table.c.srp_user == 2).distinct()
        s2 = select(table).where(table.c.srp_user == 3).distinct()
    ...
    def test_limit_offset_in_unions_from_alias(self):
        ...
        self._assert_result(
            u1.select().limit(2).order_by(u1.c.srp_user), [(2, 2, 3), (3, 3, 4)]
        )
...
class PostCompileParamsTest(
    ...
    def test_compile(self):
        ...
        stmt = select(table.c.srp_user).where(
...
class ExpandingBoundInTest(fixtures.TablesTest):
    ...
    def test_empty_in_plus_notempty_notin(self):
        ...
        stmt = (
            select(table.c.srp_user)
            .where(table.c.x.in_([]))
            .where(table.c.srp_user.not_in([2, 3]))
            .order_by(table.c.srp_user)
        )
        self._assert_result(stmt, [])
    ...
    def test_empty_set_against_integer_direct(self):
        table = self.tables.some_table
        stmt = select(table.c.srp_user).where(table.c.x.in_([])).order_by(table.c.srp_user)
        self._assert_result(stmt, [])
    ...
    def test_empty_set_against_integer_negation_direct(self):
        table = self.tables.some_table
        stmt = (
            select(table.c.srp_user).where(table.c.x.not_in([])).order_by(table.c.srp_user)
        )
    ...
    def test_empty_set_against_string_direct(self):
        table = self.tables.some_table
        stmt = select(table.c.srp_user).where(table.c.z.in_([])).order_by(table.c.srp_user)
        self._assert_result(stmt, [])
    ...
    def test_empty_set_against_string_negation_direct(self):
        table = self.tables.some_table
        stmt = (
            select(table.c.srp_user).where(table.c.z.not_in([])).order_by(table.c.srp_user)
        )
        self._assert_result(stmt, [(1,), (2,), (3,), (4,)])
...
class LikeFunctionsTest(fixtures.TablesTest):
    ...
    def _test(self, expr, expected):
        ...
        with config.db.connect() as conn:
            rows = {
                value
                for value, in conn.execute(select(some_table.c.srp_user).where(expr))
            }
    ...
    def test_select_all(self):
        with config.db.connect() as conn:
            res = conn.execute(
                ...
                .order_by(self.tables.square.c.srp_user)
            ).fetchall()
...
class IdentityColumnTest(fixtures.TablesTest):
    ...
    def test_select_all(self, connection):
        res = connection.execute(
            ...
            .order_by(self.tables.tbl_a.c.srp_user)
        ).fetchall()
        eq_(res, [(42, "a"), (43, "b")])
        ...
        res = connection.execute(
            ...
            .order_by(self.tables.tbl_b.c.srp_user)
        ).fetchall()
    ...
    def test_select_columns(self, connection):
        ...
        res = connection.execute(
            select(self.tables.tbl_a.c.srp_user).order_by(self.tables.tbl_a.c.srp_user)
        ).fetchall()
        eq_(res, [(42,), (43,)])
