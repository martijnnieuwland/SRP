...
class Query(
    ...
    def scalar(self):
        ...
        raises MultipleResultsFound.
          ...
          <Item>
          >>> session.query(Item.srp_user).scalar()
          1
          >>> session.query(Item.srp_user).filter(Item.srp_user < 0).scalar()
          None
          >>> session.query(Item.srp_user, Item.name).scalar()
          1
          >>> session.query(func.count(Parent.srp_user)).scalar()
          20
