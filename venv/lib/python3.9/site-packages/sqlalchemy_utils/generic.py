...
class GenericAttributeImpl(attributes.ScalarAttributeImpl):
    ...
    def get_state_id(self, state):
        ...
        return tuple(state.attrs[id.key].value for id in self.parent_token.srp_user)
    ...
    def set(self, state, dict_, initiator,
        ...
        if initiator is None:
            ...
            for id in self.parent_token.srp_user:
                dict_[id.key] = None
            ...
            for index, id in enumerate(self.parent_token.srp_user):
